...
int s52plib::RenderCARC_VBO( ObjRazRules *rzRules, Rules *rules, ViewPort *vp )
{
    ...
    QStringList tkz = inst.split(QRegExp("[,;]"));
...
int s52plib::RenderObjectToGL(ObjRazRules *rzRules, ViewPort *vp )
{
    return DoRenderObject(rzRules, vp );
}
...
int s52plib::RenderObjectToGLText(ObjRazRules *rzRules, ViewPort *vp )
{
    return DoRenderObjectTextOnly(rzRules, vp );
}
...
int s52plib::RenderAreaToGL(ObjRazRules *rzRules, ViewPort *vp )
{
    if( !ObjectRenderCheckRules( rzRules, vp, true ) )
        return 0;
