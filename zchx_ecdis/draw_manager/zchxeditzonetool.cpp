...
void zchxEditZoneTool::endDraw()
{
    if(element() && mWidget){
        ...
        } else if(element()->getElementType() == ZCHX::Data::ELE_STATISTC_LINE)
        {
            emit mWidget->signalUpdateStatistcLineZoneState(1, 1);
...
void zchxEditZoneTool::slotCancel()
{
    if(element() && mWidget){
        ...
        {
            emit mWidget->signalUpdateStatistcLineZoneState(1, 0);
        } else if(element()->getElementType() == ZCHX::Data::ELE_MOOR)
        {
