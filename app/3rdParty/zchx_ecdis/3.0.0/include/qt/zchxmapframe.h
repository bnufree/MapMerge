...
class zchxMapFrameWork : public QObject
{
    Q_OBJECT
public:
    explicit zchxMapFrameWork(double center_lat, double center_lon, int zoom, int width, int height, const QString& source, int pos, int min_zoom, int max_zoom, QObject *parent = 0);
