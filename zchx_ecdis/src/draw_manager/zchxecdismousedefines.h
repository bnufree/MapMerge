...
enum eTool{
    ...
    CARDMOUTHDEL,                   //删除航道
    STATISTCLINEMANAGER,            //自定义线管理
    STATISTCLINESELECT,             //选取自定义线
    STATISTCLINEMOVE,               //移动自定义线
    STATISTCLINEMOVECTRL,           //自定义线控制点微调
    STATISTCLINEDELCTRL,            //删除控制点
    STATISTCLINEADDCTRL,            //添加控制点
